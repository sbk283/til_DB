...
- [https://app.diagrams.net](https://app.diagrams.net/) (도구)
- 이메일, 이름, 나이, 비밀번호 : `사용자`
- 내용, 제목, 시간,해시태그, 좋아요 수, 작성자, 조회수, 카테고리 : `게시글`
- 누가 팔로우를 했는지 명단, 누구를 팔로우 했는지 : `팔로우`
- 신고 작성자, 신고 대상 게시글, 신고 사유 : `신고`
- 엑셀, 구글 시트 등을 표작업을 함.
- [구글시트](https://docs.google.com/spreadsheets/d/1bvY4KHtHCR1GFPV5lLfytkhchKHNNc99E0PimAen7y0/edit?gid=1621841410#gid=1621841410)
